...
exports.InMemoryTenantsRepository = exports.IN_MEMORY_TENANT_IDS = void 0;
var IN_MEMORY_TENANT_IDS;
(function (IN_MEMORY_TENANT_IDS) {
    IN_MEMORY_TENANT_IDS["MARCELO_BRASIL"] = "faefe160-0c9b-4634-95ab-007c9286bbba";
})(IN_MEMORY_TENANT_IDS || (exports.IN_MEMORY_TENANT_IDS = IN_MEMORY_TENANT_IDS = {}));
class InMemoryTenantsRepository {
    constructor() {
        this._tenants = [
            {
...
exports.InMemoryTenantsRepository = InMemoryTenantsRepository;
