...
type hipotese = 'adicional_noturno' | 'descaracterizacao_cargo_confianca' | 'horas_extras_nao_pagas' | 'horas_extras_nao_pagas_sabados' | 'horas_extras_nao_pagas_segunda_a_sabado' | 'horas_extras_nao_pagas_segunda_a_sexta' | 'horas_extras_pagas_parcialmente' | 'horas_extras_pagas_por_fora' | 'jornada_trabalho_12_36' | 'labor_aos_domingos_sem_contraprestacao' | 'labor_em_feriados' | 'prontidao' | 'sobreaviso' | 'supressao_intervalo_interjornada' | 'supressao_intervalo_intrajornada';
...
export {};
//# sourceMappingURL=pedido_jornada_trabalho.d.ts.map